...
insert Tb_Perfil values (3,'CONFERENCIA','1','0');
insert Tb_Perfil values (2,'GERENCIA','1','0');
...
INSERT INTO Tb_Usuario VALUES (12,"Aaron","16320304153",3,"167711089","Giles","123","sem.Pellentesque.ut@utlacusNulla.com","5793970655","12262592452",'m',"70209370","Quisque Av.","345","Delaware","Wilmington","MG",'2019-09-08', now(),1);
INSERT INTO Tb_Usuario VALUES (13,"Rajah","16591010627",4,"161809087","Jarvis","123","ac.mattis.semper@volutpat.co.uk","1507020545","22816522908",'f',"18455643","Fermentum Avenue","9","TO","Berlin","TO",'2019-09-08', now(),1);
INSERT INTO Tb_Usuario VALUES (15,"Dexter","16921101394",3,"161212038","Byrd","123","interdum.enim@sitamet.co.uk","69814325679","19370178943",'m',"64613286","Nec Street","279","Lubelskie","Zamość","RJ",'2019-09-08', now(),1);
INSERT INTO Tb_Usuario VALUES (16,"Alfonso","16250521455",7,"165106029","Baxter","123","quis.pede.Suspendisse@augue.co.uk","3441114885","36978339463",'m',"87621267","Euismod St.","94","South Island","Christchurch","RJ",'2019-09-08', now(),1);
INSERT INTO Tb_Usuario VALUES (17,"Aline","16371228603",3,"166704138","Cantu","123","augue@rutrumjusto.co.uk","3796903169","29597843136",'f',"12050884","Viverra. Street","7","Metropolitana de Santiago","Maipú","SP",'2019-09-11', now(),1);
INSERT INTO Tb_Usuario VALUES (18,"José Doria","16371228603",2,"166704138","doria","123","doria@doria.com","3796903169","29597843136",'m',"12050884","Viverra. Street","7","Metropolitana de Santiago","Maipú","SP",'2019-09-11', now(),1);
...
insert into Tb_TipoProduto (idTipoProduto,nomeTipoProduto,idUnidade,usuarioCadastro) values (1,'PRODUTO ANIMAL',6,1 );
...
insert into Tb_Fornecedor values (1,'Extra Supermercados','33041260065290','06670420','Rua das Nações Unidadas',30,'Jardim das Flores','Cotia','SP','Almir Castro da Silva','551142451123','551142451123','almir@extra.com.br',7,now(),now(),1);
...
start transaction;
	...
	insert into Tb_Produto (nomeProduto,marcaProduto,codigoBarras,descricaoProduto,idUnidadeAbreviada,valorMedida,idPrecoVenda,idTipoProduto,idUsuarioCadastroProduto,dataCadastro,estoqueMinimo,dataMinimo,ativo) 
		values ('MAIONESE','HELLMANS','123123333333','CREME DE MAIONESE',1,0.300,last_insert_id(),10,1,now(),200,date_add(NOW(), interval 10 DAY),1);
commit;

start transaction;
    insert into Tb_PrecoVenda (dataCadastroPreco,precoVenda) values (now(),5.80);
	insert into Tb_Produto (nomeProduto,marcaProduto,codigoBarras,descricaoProduto,idUnidadeAbreviada,valorMedida,idPrecoVenda,idTipoProduto,idUsuarioCadastroProduto,dataCadastro,estoqueMinimo,dataMinimo,ativo) 
		values ('SABÃO EM PÓ','OMO','1111111111111','SABÃO EM PÓ PARA ROUPAS',1,1.000,last_insert_id(),8,1,now(),100,date_add(NOW(), interval 10 DAY),1);
commit;
start transaction;
    insert into Tb_PrecoVenda (dataCadastroPreco,precoVenda) values (now(),3.40);
	insert into Tb_Produto (nomeProduto,marcaProduto,codigoBarras,descricaoProduto,idUnidadeAbreviada,valorMedida,idPrecoVenda,idTipoProduto,idUsuarioCadastroProduto,dataCadastro,estoqueMinimo,dataMinimo,ativo) 
		values ('FARINHA DE TRIGO','DONA BENTA','2222222222222','FARINHA DE TRIGO NÃO AFERMENTADO',1,1.000,last_insert_id(),10,1,now(),300,date_add(NOW(), interval 10 DAY),1);
commit;
start transaction;
    insert into Tb_PrecoVenda (dataCadastroPreco,precoVenda) values (now(),13.00);
	insert into Tb_Produto (nomeProduto,marcaProduto,codigoBarras,descricaoProduto,idUnidadeAbreviada,valorMedida,idPrecoVenda,idTipoProduto,idUsuarioCadastroProduto,dataCadastro,estoqueMinimo,dataMinimo,ativo) 
		values ('ARROZ TIPO 1','PRATO FINO','3333333333333','ARROZ BRANCO TIPO 1',1,5.000,last_insert_id(),10,1,now(),300,date_add(NOW(), interval 10 DAY),1);
commit;
start transaction;
    insert into Tb_PrecoVenda (dataCadastroPreco,precoVenda) values (now(),5.99);
	insert into Tb_Produto (nomeProduto,marcaProduto,codigoBarras,descricaoProduto,idUnidadeAbreviada,valorMedida,idPrecoVenda,idTipoProduto,idUsuarioCadastroProduto,dataCadastro,estoqueMinimo,dataMinimo,ativo) 
		values ('GRAXA LIQUIDO PRETO','NUGGET','4444444444444','GRAXA PRETO LÍQUIDO COR PRETA',1,0.200,last_insert_id(),3,1,now(),80,date_add(NOW(), interval 10 DAY),1);
commit;
start transaction;
    insert into Tb_PrecoVenda (dataCadastroPreco,precoVenda) values (now(),6.99);
	insert into Tb_Produto (nomeProduto,marcaProduto,codigoBarras,descricaoProduto,idUnidadeAbreviada,valorMedida,idPrecoVenda,idTipoProduto,idUsuarioCadastroProduto,dataCadastro,estoqueMinimo,dataMinimo,ativo) 
		values ('PATINHO DE BOI','CARNESUL','5555555555555','PATINHO DE BOI',1,1.250,last_insert_id(),9,1,now(),200,date_add(NOW(), interval 10 DAY),1);
commit;
...
insert into Tb_CompraProduto (numeroPedido,numeroNotaFiscal,dataCompra,dataEntrega,idUsuarioCadastro,idFornecedor,estadoCompra,valorTotalCompra)
	...
	insert into Tb_ListaProduto (idPedido,produto,valorUnitario,quantidadeProduto)
		values (1,1,2.88,last_insert_id());
        
	insert into Tb_Quantidade (quantidade) values (300);
	insert into Tb_ListaProduto (idPedido,produto,valorUnitario,quantidadeProduto)
		values (1,2,0.88,last_insert_id());
commit;
start transaction;
insert into Tb_CompraProduto (numeroPedido,numeroNotaFiscal,dataCompra,dataEntrega,idUsuarioCadastro,idFornecedor,estadoCompra,valorTotalCompra)
	values ('11111111','878179198',now(),date_add(NOW(), interval 10 DAY),1,2,'AGUARDANDO',0);
    insert into Tb_Quantidade (quantidade) values (100);
	insert into Tb_ListaProduto (idPedido,produto,valorUnitario,quantidadeProduto)
		values (2,3,3.88,last_insert_id());
        
	insert into Tb_Quantidade (quantidade) values (800);
	insert into Tb_ListaProduto (idPedido,produto,valorUnitario,quantidadeProduto)
		values (2,4,4.88,last_insert_id());
commit;
...
/*SELECT * FROM TB_LOTE*/
start transaction;
	insert into Tb_Lote (dataEntrada,dataValidade,idUsuario,idCompraProduto,idProdutoLote,quantidadeLote) 
		values (now(),now(),6,1,1,1);
	UPDATE Tb_CompraProduto SET estadoCompra = 'RECEBIDO' where idCompraProduto = 2;
commit;
        /*select * from tb_lote;*/
        /*select * from Tb_CompraProduto TP
        inner join Tb_Lote TL
			on TL.idProdutoLote = TP.idProduto
		inner join Tb_CompraProduto TCP
			on TCP.idProduto = TP.idProduto;
        */
...
insert into Tb_Venda values (1,1,10,4.79,now(),1);
insert into Tb_Venda values (2,2,3,3.29,now(),1);
insert into Tb_Venda values (3,3,55,7.99,now(),1);
insert into Tb_Venda values (4,4,14,2.59,now(),1);

insert into Tb_Venda values (6,1,1,9.99,'2018-05-01',1);
insert into Tb_Venda values (7,2,2,2.99,'2019-02-01',1);
insert into Tb_Venda values (8,3,15,0.99,'2019-10-19',1);
insert into Tb_Venda values (9,4,9,1.59,'2019-09-10',1);
...
SELECT Tb_Venda.idProduto, SUM(Tb_Venda.quantidadeVenda) AS vendaTotal, Tb_Produto.nomeProduto  FROM Tb_Venda INNER JOIN Tb_Produto ON Tb_Produto.idProduto = Tb_Venda.idProduto GROUP BY Tb_Venda.idProduto ORDER BY vendaTotal DESC;
