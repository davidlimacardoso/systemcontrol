...
<div class="wrapper">
  ...
  <div class="container mt-2">  
	...
	<div class="text-center">
		...
		<p class="lead">Deixe sua dúvida ou sugestão que entraremos em contato com uma resposta.</p>
	</div>
			...
			<div class="col-md-8 mx-auto">
				...
				<div class="card-body font-weight-bold">
					<form action="validacoes/processa_envio.php" method="post">
						...
						<button type="submit" class="btn btn-secondary btn-lg float-right">Enviar Mensagem</button>
					</form>
				</div>
			</div>
		</div>
