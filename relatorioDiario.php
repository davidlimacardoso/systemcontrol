...
<script type="text/javascript" src="js/mascara.js"></script>
    ...
    <div class="d-flex justify-content-between">
	   <span class="mt-n4 mb-2 lead"><i class="fas fa-calendar-day mr-2"></i><?php echo "RELATÓRIO DIÁRIO"; ?></span>
  						...
  						<div class="form-group">
							...
							<!--<form>
								<div class="form-group" id="dia">
									<?php date_default_timezone_set('America/Sao_Paulo'); ?>
									<label class="form-label ml-4">data inicio</label>
									<input class="ml-1" name="dataInicio" id="dataInicio" type="date" value="<?php echo date('Y-m-d'); ?>" />
									<label class="form-label ml-4">data fim</label>
									<input class="ml-1" name="dataFim" id="dataFim" type="date" value="<?php echo date('Y-m-d'); ?>" />
								</div>
							</form>-->
						</div>
					</form>
							 ...
							 <?php
				              if (isset($_SESSION['empresaNome'])){
				                ...
				                $script = "SELECT sum(quantidadeVenda * precoVendido) AS valorVendas, count(idVenda) AS quantVenda FROM Tb_Venda 
									WHERE DATE(Tb_Venda.dataVenda) = DATE(NOW()) && tipoVenda = 'd'";
						...
						<div class="card-body">
							 ...
							 <?php
				              if (isset($_SESSION['empresaNome'])){
				                ...
				                $script = "SELECT sum(quantidadeVenda * precoVendido) AS valorVendas, count(idVenda) AS quantVenda FROM Tb_Venda 
									WHERE DATE(Tb_Venda.dataVenda) = DATE(NOW()) && tipoVenda = 'cd'";
						...
						<div class="card-body">
							 <h5 class="card-title" id="totalVendas">
				              ...
				              if (isset($_SESSION['empresaNome'])){
				                ...
				                $script = "SELECT sum(quantidadeVenda * precoVendido) AS valorVendas, count(idVenda) AS quantVenda FROM Tb_Venda 
									WHERE DATE(Tb_Venda.dataVenda) = DATE(NOW()) && tipoVenda = 'cc'";
						...
						<div class="card-body">
							 ...
							 <?php
				              if (isset($_SESSION['empresaNome'])){
				                ...
				                $script = "SELECT count(idVenda) AS quantVenda FROM Tb_Venda WHERE DATE(Tb_Venda.dataVenda) = DATE(NOW())";
						...
						<div class="card-body">
							 ...
							 <?php
				              if (isset($_SESSION['empresaNome'])){
				                ...
				                $script = "SELECT SUM(Tb_Venda.quantidadeVenda) AS quantProd FROM Tb_Venda WHERE DATE(Tb_Venda.dataVenda) = DATE(NOW())";
						...
						<div class="card-body">
							 <h5 class="card-title" id="totalVendas">
				              ...
				              if (isset($_SESSION['empresaNome'])){
				                ...
				                $script = "SELECT SUM(Tb_Venda.quantidadeVenda * Tb_Venda.precoVendido) AS totalVenda FROM Tb_Venda WHERE DATE(Tb_Venda.dataVenda) = DATE(NOW())";
				              ...
				              ?>
				                   <p class="card-text h3 text-center" style="color: <?php  echo "#000";?>;">R$ <?php echo number_format($linha['totalVenda'],2,",","."); ?></p>
				            <?php }
				                } 
				              }else{
				                ?>
		...
		<hr>
			...
			<section class="mt-4">
					<div class="container mt-3">
						<div class="row mb-3">
							<div class="col-6">
					          <div id="chart_Dia" style="width: 515px; height: 300px;"></div>
					        </div>
					        <div class="col-md-6">
								<div class="card border-dark shadow">
			          				<div class="card-header text-center" style="background-color: <?php if (!isset($_SESSION['corMenuFundo'])) { echo "#c0c0c0";}else{ echo $_SESSION['corMenuFundo']; }?>;">
			          					<h6>PRODUTOS VENDIDOS DO DIA</h6>
			          				</div>
				          			<div class="card-body">
				            			<table class="shadow responsive text-center hover display compact stripe nowrap" id="tabelaVendaDia">
				              				<thead>
				                				<tr>
				                  					<th>CÓDIGO</th>
				                  					<th>PRODUTO</th>
				              			...
				              			<?php
											...
											WHERE DATE(Tb_Venda.dataVenda) = DATE(NOW()) 
						...
						<div class="row mb-3">
							<div class="col-md-6">
								<div class="card border-dark shadow">
				          			...
				          			<div class="card-body">
				            			<table class="shadow responsive text-center hover display compact stripe nowrap" id="tabelaCategoriaDia">
				              				<thead>
				                				<tr>
				                  					<th>CÓDIGO</th>
				                  					<th>PRODUTO</th>
							...
							<div class="col-6">
								<div id="barchart_Categoria_Dia" style="width: 900px; height: 300px;"></div>
							</div>				
						</div>
					</div>
			</section>
		</div>
<!--FIM DO RELATORIO DIA-->
	</div>
</div>
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    function drawChart() {
      ...
      var chart = new google.visualization.BarChart(document.getElementById("barchart_Categoria_Dia"));
